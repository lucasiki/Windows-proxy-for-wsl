...
type WSLInfo struct {
	IP       string // e.g. "172.22.48.1"
	Mode     string // "mirrored" or "NAT"
	TargetIP string // IP to forward connections to
}
...
func DetectWSL() *WSLInfo {
	...
	// Determine if mirrored mode: WSL IP matches one of the local host IPs.
